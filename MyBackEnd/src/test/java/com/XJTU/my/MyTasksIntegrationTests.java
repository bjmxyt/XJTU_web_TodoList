...
public class MyTasksIntegrationTests {
    ...
    public void shouldSaveTask() throws Exception {
        this.mockMvc.perform(post("/api/tasks")
                .content("{ \"Task_id\" : 2, \"content\" : \"check if it works\" }")
    ...
    @Test
    @Order(3)
    public void shouldGetTaskByTaskTask_id() throws Exception {
    ...
    @Test
    @Order(4)
    public void shouldUpdateContentByTaskTask_id() throws Exception {
    ...
    @Test
    @Order(5)
    public void shouldDeleteByTaskTask_id() throws Exception {
